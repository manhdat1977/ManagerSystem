                        ...
                        <div class="row">
                            <div class="col-2">
                                <label>Nhập số bảng kê</label>
                                    <asp:TextBox runat="server" ID="txtSoBKe" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-2">
                                <label>Kỳ in bảng kê</label>
                                <asp:TextBox runat="server" ID="txtKyIn" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                 <label>Người ký</label>
                                <asp:DropDownList CssClass="form-control" ID="dropNguoiKy" runat="server">
                                            ...
                                            <asp:ListItem Text="Trần Công Minh" Value="TRAN CONG MINH"></asp:ListItem>
                                        </asp:DropDownList>
                            </div>
                            <div class="col-1">
