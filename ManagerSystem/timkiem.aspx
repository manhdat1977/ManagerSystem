                                                    ...
                                                    <asp:TemplateField HeaderText="Lịch sử đơn">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Panel ID="pnlChildGrid" runat="server" Style="display: none">
                                                                <asp:GridView BorderWidth="1px" runat="server" ID="gridHistory" CssClass="table table-bordered table-hover dataTable"
                                                                    AutoGenerateColumns="False" BorderColor="Black" BackColor="Black" BorderStyle="Dashed">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="SCVan" HeaderText="Số CV" />
                                                                        <asp:BoundField DataField="NLCVan" HeaderText="Ngày lập CV" />
